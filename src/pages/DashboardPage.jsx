...
export default function DashboardPage() {
  ...
  const shareNow = async () => {
    ...
    try {
      ...
      // Try Web Share API first (works on mobile outside iframes)
      ...
      if (newWindow) {
        newWindow.document.write(`
          ...
          <body>
            <div class="container">
              <h1>📱 Save & Share Your Message</h1>

              <img src="${shareImageUrl}" id="shareImage" alt="Secret Message" />

              <div class="instructions">
                <h2>How to Save & Share:</h2>
                <div class="step">
                  <span class="step-number">1</span>
                  <span><span class="highlight">Long press</span> the image above</span>
                </div>
                <div class="step">
                  <span class="step-number">2</span>
                  <span>Tap <span class="highlight">"Save Image"</span> or <span class="highlight">"Download Image"</span></span>
                </div>
                <div class="step">
                  <span class="step-number">3</span>
                  <span>Open Photos/Gallery and share to WhatsApp, Instagram, Telegram, etc!</span>
                </div>
              </div>

              <button onclick="tryShare()">📤 Try Share Now</button>
            </div>
              ...
              async function tryShare() {
                try {
                  ...
                  if (navigator.share && navigator.canShare && navigator.canShare({ files: [file] })) {
                    ...
                    alert('💡 Tip: Long press the image above and tap "Save Image" to save it to your gallery!');
                  }
                } catch (err) {
                  if (err.name !== 'AbortError') {
                    alert('💡 Long press the image above and tap "Save Image" to save it!');
                  }
                }
              }
            </script>
